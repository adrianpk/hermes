...
func (repo *BaseRepo) RemoveRole(ctx context.Context, userID, roleID uuid.UUID) error {
	repo.mu.Lock()
	defer repo.mu.Unlock()
...
func (repo *BaseRepo) RemovePermissionFromUser(ctx context.Context, userID, permissionID uuid.UUID) error {
	repo.mu.Lock()
	defer repo.mu.Unlock()
...
func (repo *BaseRepo) AddPermissionToRole(ctx context.Context, roleID, permissionID uuid.UUID) error {
...
func (repo *BaseRepo) RemovePermissionFromRole(ctx context.Context, roleID, permissionID uuid.UUID) error {
	role, err := repo.GetRole(ctx, roleID)
	if err != nil {
		return err
	}
...
func (repo *BaseRepo) RemovePermissionFromResource(ctx context.Context, resourceID, permissionID uuid.UUID) error {
	repo.mu.Lock()
	defer repo.mu.Unlock()
